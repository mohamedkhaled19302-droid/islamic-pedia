          ...
          <div className="mt-4 grid grid-cols-2 gap-3 sm:grid-cols-3">
            {THEMES.map((th) => (
              <button
                ...
                className={`flex items-center gap-2 rounded-2xl border p-3 text-right transition-all ltr:text-left ${
              ...
              >
                ...
                />
                <span className="min-w-0 flex-1 truncate text-sm font-bold text-foreground">{th.name}</span>
